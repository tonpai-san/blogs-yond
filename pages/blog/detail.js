            ...
            <Layout>
                <div className="container">
                    ...
                    <div className="col-6">
                        ...
                        <hr/>
                    <h5 className="text-success">เขียนโดย {blog.created_by.user.firstname} {blog.created_by.user.lastname}</h5>
                    <h5 className="text-muted text-right"> แก้ไขเมื่อ {updated_date.toLocaleDateString()}</h5>
                    </div>
